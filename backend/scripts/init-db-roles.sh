...
ALTER DEFAULT PRIVILEGES FOR ROLE diary_migrator IN SCHEMA public GRANT SELECT, INSERT, UPDATE, DELETE ON TABLES TO diary_app;
ALTER DEFAULT PRIVILEGES FOR ROLE diary_migrator IN SCHEMA public GRANT USAGE, SELECT ON SEQUENCES TO diary_app;
SQL
